...
namespace Elements.Items.Aer.Weapons
{
    /// <summary>
    /// Dash around like some kind of... cyborg ninja
    /// </summary>
    public class Odati : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Odati");
            DisplayName.AddTranslation(GameCulture.Russian, "Одати");

            Tooltip.SetDefault(
                 "Odati is an unusually accurate weapon, seeking weak points automatically.");
            Tooltip.AddTranslation(GameCulture.Russian,
            "Одати отыскивает слабые места врагов и бьет точно в них");
        }
        public override void SetDefaults()
        {
            ...
            item.shoot = mod.ProjectileType<Projectiles.OdatiSlash>();
            item.shootSpeed = 16f;
